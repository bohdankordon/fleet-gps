...
const initial: AdminSettings = { timezone: "Europe/Kyiv", minimumDailyDistanceMeters: 100, positionFreshnessSeconds: 60, speedRuleEnabled: true, citySpeedLimitKph: 50, outsideCitySpeedLimitKph: 90, speedToleranceKph: 10, speedingConfirmationUpdates: 2, inactivityRuleEnabled: true, inactivityDistanceMeters: 100, inactivityDurationMinutes: 30, tripMovementSpeedKph: 5, tripMovementConfirmationSeconds: 60, tripStopConfirmationSeconds: 300, tripDataGapSeconds: 300, cityGeofence: { configured: false, ringCount: 0, pointCount: 0 }, updatedAt: "2026-08-27T00:00:00.000Z", revision: 7 };
