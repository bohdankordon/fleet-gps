...
test("renders policy, anchor, fleet, backfill, observation, checkpoint, and bounded operation language", () => {
  ...
  for (const expected of ["История GPS", "История GPS: 90 дней", "План на контрольную точку", formatDateTime("ru", "2026-08-11T02:00:00.000Z")!, "Provider-disabled", "Целей обработано", "GPS-наблюдения", "Строк наблюдений", "COMPLETED", "RUNNING", "PENDING", "NONE", "Операционные режимы", "6 / 12 / 24", "500 / 1000 / 5000"]) assert.ok(html.includes(expected), expected);
