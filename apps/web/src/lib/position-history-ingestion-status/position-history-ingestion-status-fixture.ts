...
const noActive = { activeGenerationAnchor: null, activeState: null, activeCheckpointsTotal: 0, activeCheckpointsCompleted: 0, activeCheckpointsRemaining: 0, activeProgressPercent: null, activeIsOverdue: false, queuedIncompleteGenerations: 0, estimatedRemainingWindows: 0 } as const;
...
export function positionHistoryIngestionStatusStateFixture(state: PositionHistoryIngestionStatusState): PositionHistoryIngestionStatusResponse {
  ...
  if (state === "REPLAYING") return {
    ...
    replay: {
      daily: { ...daily, state: "RUNNING", checkpointsCompleted: 35, checkpointsRemaining: 23, progressPercent: 60, isCurrent: true, incompleteGenerations: 1, activeGenerationAnchor: daily.generationAnchor, activeState: "RUNNING", activeCheckpointsTotal: 58, activeCheckpointsCompleted: 35, activeCheckpointsRemaining: 23, activeProgressPercent: 60, estimatedRemainingWindows: 150 },
      rolling: { ...rolling, state: "RUNNING", generationAnchor: "2026-09-15T02:00:00.000Z", rangeFrom: "2026-06-17T02:00:00.000Z", rangeTo: "2026-09-15T02:00:00.000Z", checkpointsCompleted: 121, checkpointsRemaining: 633, progressPercent: 16, isCurrent: true, incompleteGenerations: 1, activeGenerationAnchor: "2026-09-15T02:00:00.000Z", activeState: "RUNNING", activeCheckpointsTotal: 754, activeCheckpointsCompleted: 121, activeCheckpointsRemaining: 633, activeProgressPercent: 16, estimatedRemainingWindows: 11_000 },
    },
  };
  return {
    ...healthy,
    ...
    replay: {
      daily: { ...daily, state: "RUNNING", checkpointsCompleted: 12, checkpointsRemaining: 46, progressPercent: 20, isCurrent: false, debtSuspected: true, incompleteGenerations: 3, overdueIncompleteGenerations: 2, oldestIncompleteGenerationAnchor: "2026-09-11T02:00:00.000Z", oldestOverdueGenerationAnchor: "2026-09-11T02:00:00.000Z", hasReplayDebt: true, activeGenerationAnchor: "2026-09-11T02:00:00.000Z", activeState: "RUNNING", activeCheckpointsTotal: 58, activeCheckpointsCompleted: 12, activeCheckpointsRemaining: 46, activeProgressPercent: 20, activeIsOverdue: true, queuedIncompleteGenerations: 2, estimatedRemainingWindows: 900 },
      rolling: { ...rolling, state: "PENDING", generationAnchor: "2026-09-08T02:00:00.000Z", rangeFrom: "2026-06-10T02:00:00.000Z", rangeTo: "2026-09-08T02:00:00.000Z", checkpointsTotal: 0, checkpointsCompleted: 0, checkpointsRemaining: 0, progressPercent: null, isCurrent: true, debtSuspected: false, incompleteGenerations: 2, overdueIncompleteGenerations: 1, oldestIncompleteGenerationAnchor: "2026-09-01T02:00:00.000Z", oldestOverdueGenerationAnchor: "2026-09-01T02:00:00.000Z", hasReplayDebt: true, activeGenerationAnchor: "2026-09-01T02:00:00.000Z", activeState: "PENDING", activeCheckpointsTotal: 741, activeCheckpointsCompleted: 366, activeCheckpointsRemaining: 375, activeProgressPercent: 49, activeIsOverdue: true, queuedIncompleteGenerations: 1, estimatedRemainingWindows: 10_488 },
    },
  };
}
