...
const admin: AdminManagedUser = { id: "admin-id", login: "owner", role: "ADMIN", disabled: false, mustChangePassword: false, permissions: [], vehicleAccess: { mode: "ALL", groupIds: [], vehicleIds: [] }, telegramStatus: "CONNECTED", createdAt: "2026-08-01T10:00:00Z", updatedAt: "2026-09-01T10:00:00Z" };
const operator: AdminManagedUser = { id: "operator-id", login: "operator", role: "USER", disabled: false, mustChangePassword: true, permissions: ["fleet.view", "map.view", "vehicles.view", "trips.view", "reports.view"], vehicleAccess: { mode: "ALL", groupIds: [], vehicleIds: [] }, telegramStatus: "NOT_CONNECTED", createdAt: "2026-08-02T10:00:00Z", updatedAt: "2026-09-02T10:00:00Z" };
const disabled: AdminManagedUser = { ...operator, id: "disabled-id", login: "former", disabled: true, mustChangePassword: false, permissions: [], vehicleAccess: { mode: "ALL", groupIds: [], vehicleIds: [] }, telegramStatus: "BROKEN" };
