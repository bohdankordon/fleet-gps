...
test("validates empty, SPEEDING, and INACTIVITY Stage 8A public alert-event contracts", () => {
  ...
  const inactivity = { ...alertEventsListFixture, items: [{ id: "00000000-0000-4000-8000-000000000003", vehicle: { id: "00000000-0000-4000-8000-000000000002", name: "Такси 8" }, type: "INACTIVITY", status: "RESOLVED", openedAt: "2026-08-08T12:00:00.000Z", resolvedAt: "2026-08-08T13:00:00.000Z", notificationDeliveryStatus: "SENT", details: { confirmationDistanceMeters: 20, lastDistanceMeters: 40, minimumDistanceMeters: 12, distanceThresholdMeters: 300, durationThresholdMinutes: 60 } }] };
