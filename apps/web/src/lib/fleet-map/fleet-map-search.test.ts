...
const snapshot: FleetMapResponse = {
  ...
  vehicles: [
    { vehicle: { id: "00000000-0000-4000-8000-000000000001", name: "TAXI AB5466YA", group: null }, position: { latitude: 49, longitude: 28, observedAt: "2026-08-10T12:00:00.000Z" }, speedKph: 12, freshness: "FRESH" },
    { vehicle: { id: "00000000-0000-4000-8000-000000000002", name: "Service Van", group: null }, position: { latitude: 49.1, longitude: 28.1, observedAt: "2026-08-10T11:00:00.000Z" }, speedKph: null, freshness: "STALE" },
  ],
};
