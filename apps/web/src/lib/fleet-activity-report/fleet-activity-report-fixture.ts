...
export function fleetActivityReportFixture(): FleetActivityReportResponse {
  return {
    ...
    vehicles: [
      { vehicleId: "00000000-0000-4000-8000-000000000001", vehicleName: "Taxi A", hasGpsData: true, rawObservationCount: 20, firstObservationAt: "2026-08-10T05:00:00.000Z", lastObservationAt: "2026-08-10T10:00:00.000Z", tripCount: 2, observedDistanceMeters: 12000, tripDurationSeconds: 3600, stopCount: 1, stopDurationSeconds: 600, gapCount: 1, gapDurationSeconds: 600 },
      { vehicleId: "00000000-0000-4000-8000-000000000002", vehicleName: "Taxi B", hasGpsData: false, rawObservationCount: 0, firstObservationAt: null, lastObservationAt: null, tripCount: 0, observedDistanceMeters: 0, tripDurationSeconds: 0, stopCount: 0, stopDurationSeconds: 0, gapCount: 0, gapDurationSeconds: 0 },
    ],
  };
}
