...
export function isActiveAppNavigationPath(href: string, pathname: string): boolean { if (href === "/admin/users" && pathname.startsWith("/admin/")) return true; if (href === "/") return pathname === href || pathname.startsWith("/vehicles/"); return pathname === href || pathname.startsWith(`${href}/`); }
