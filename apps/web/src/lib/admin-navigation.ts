...
export function adminNavigationFor(user: AuthUser | null, locale: AppLocale = DEFAULT_LOCALE): readonly AdminNavigationItem[] {
  ...
  if (user.role === "ADMIN") items.push({ href: "/admin/users", label: translate(locale, "navigation.users") }, { href: "/admin/vehicle-groups", label: translate(locale, "navigation.vehicleGroups") }, { href: "/admin/settings", label: translate(locale, "navigation.settings") }, { href: "/admin/audit", label: translate(locale, "navigation.audit") });
