...
const result = { canonicalAnchor: body.expectedCanonicalAnchor, policyCutoff: body.expectedPolicyCutoff, advancedCursorFloors: 1, advancedReplayCheckpoints: 2, completedReplayCheckpoints: 1, deletedCheckpoints: 1, deletedObservations: 2, moreCheckpointWork: false, moreObservationWork: false, stoppedByBudget: false, noWork: false };
