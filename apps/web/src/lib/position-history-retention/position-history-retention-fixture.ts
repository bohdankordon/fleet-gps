...
export function positionHistoryRetentionFixture(overlap = 2): PositionHistoryRetentionPlan {
  return {
    ...
    observations: { total: 100, olderThanPolicyCutoff: 20, atOrAfterPolicyCutoff: 80, oldestObservedAt: "2026-04-01T00:00:00.000Z", newestObservedAt: "2026-08-13T00:00:00.000Z", vehiclesWithObservationsOlderThanCutoff: 4 },
    checkpoints: {
      total: 8 + overlap,
      fullyObsolete: 3,
