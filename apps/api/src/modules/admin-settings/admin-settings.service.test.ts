...
function row(overrides: Record<string, unknown> = {}) { return { timezone: "Europe/Kyiv", minimumDailyDistanceMeters: 500, positionFreshnessSeconds: 300, speedRuleEnabled: true, citySpeedLimitKph: 50, outsideCitySpeedLimitKph: 90, speedToleranceKph: 10, speedingConfirmationUpdates: 2, inactivityRuleEnabled: true, inactivityDistanceMeters: 300, inactivityDurationMinutes: 60, cityGeofenceGeoJson: null, updatedAt: new Date("2026-08-01T00:00:00Z"), revision: 1, ...overrides }; }
