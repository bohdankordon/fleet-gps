...
/** Shared operator/storage policy for the active horizon and retention cutoff. */
export const POSITION_HISTORY_POLICY_DAYS = 90;
export const POSITION_HISTORY_HORIZON_POLICY = Object.freeze({
  days: POSITION_HISTORY_POLICY_DAYS,
  durationMs: POSITION_HISTORY_POLICY_DAYS * POSITION_HISTORY_ABSOLUTE_DAY_MS,
