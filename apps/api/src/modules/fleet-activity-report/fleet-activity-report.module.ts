...
@Module({ imports: [DatabaseModule, TripStopAnalyticsModule], controllers: [FleetActivityReportController], providers: [{ provide: FLEET_ACTIVITY_REPORT_REPOSITORY, useExisting: PrismaFleetActivityReportRepository }, PrismaFleetActivityReportRepository, FleetActivityReportService] })
