...
const config: ApiConfig = Object.freeze({ host: "127.0.0.1", port: 3000, database: Object.freeze({ url: "postgresql://unused:unused@example.test/db", poolMax: 1, connectionTimeoutMs: 100, idleTimeoutMs: 1_000 }), syncScheduler: Object.freeze({ enabled: false, fleetIntervalSeconds: 60, runsIntervalSeconds: 300, shutdownTimeoutMs: 50_000 }), equGps: Object.freeze({ officialBaseUrl: "https://unused.invalid", webBaseUrl: "https://unused.invalid", email: "unused@example.test", password: "unused", requestTimeoutMs: 100, runsRequestTimeoutMs: 100 }) });
