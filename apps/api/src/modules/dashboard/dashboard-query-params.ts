...
export type DashboardQueryParams = Readonly<{ search: string | undefined; status: DashboardStatusFilter | undefined; activity: DashboardActivityFilter | undefined; includeDisabled: boolean }>;
...
export function parseDashboardQueryParams(query: Readonly<Record<string, unknown>>): DashboardQueryParams {
  ...
  return Object.freeze({ search, status: rawStatus, activity: rawActivity, includeDisabled: rawDisabled === undefined ? true : rawDisabled === "true" });
}
