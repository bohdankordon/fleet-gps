...
const equGpsIssueNames: Readonly<Record<string, string>> = Object.freeze({ officialBaseUrl: "EQUGPS_BASE_URL", webBaseUrl: "EQUGPS_WEB_BASE_URL", email: "EQUGPS_EMAIL", password: "EQUGPS_PASSWORD", requestTimeoutMs: "EQUGPS_REQUEST_TIMEOUT_MS", runsRequestTimeoutMs: "EQUGPS_RUNS_TIMEOUT_MS" });
