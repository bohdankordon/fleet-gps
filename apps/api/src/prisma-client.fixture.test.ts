...
function typecheckDelegates(client: PrismaClient): void { void client.vehicle; void client.vehicleCurrentState; void client.dailyVehicleStat; void client.applicationSettings; }
