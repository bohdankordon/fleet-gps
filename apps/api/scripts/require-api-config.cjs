...
const allowedFields = new Set([
  ...
  "ALERT_INGESTION_ENABLED", "POSITION_HISTORY_MAINTENANCE_ENABLED", "POSITION_HISTORY_RETENTION_ENABLED", "POSITION_HISTORY_CONTINUOUS_INGESTION_ENABLED", "TELEGRAM_NOTIFICATIONS_ENABLED", "TELEGRAM_BOT_TOKEN", "TELEGRAM_CHAT_ID",
  "TELEGRAM_PER_USER_NOTIFICATIONS_ENABLED",
  "TELEGRAM_PER_USER_DISPATCH_ENABLED", "TELEGRAM_PER_USER_DISPATCH_INTERVAL_MS", "TELEGRAM_PER_USER_DISPATCH_BATCH_SIZE", "TELEGRAM_PER_USER_DISPATCH_NOT_BEFORE",
  "TELEGRAM_PRODUCT_LINKING_ENABLED", "TELEGRAM_PRODUCT_BOT_USERNAME", "TELEGRAM_PRODUCT_BOT_TOKEN", "TELEGRAM_PRODUCT_WEBHOOK_SECRET",
